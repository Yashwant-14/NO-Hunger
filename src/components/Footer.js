    ...
    <footer className='mt-6 md:mt-0 bg-[#02060C] text-white py-12 px-8 md:px-56'>
      <div className='container grid grid-cols-1 text-center  md:grid-cols-4 gap-4 mx-auto'>
        ...
        <div className='md:col-start-1 col-end-auto row-start-1 row-end-5'>
          <h2 className='text-2xl font-bold'> NoHunger</h2>
          <h4 className='text-gray-300 my-4'>© 2024 made By Yashwant </h4>
        </div>
        ...
        <div className='md-col-start-2'>
          ...
          <ul>
            <li className='my-4'>
              <Link to='https://www.linkedin.com/in/yashwant-yadav14/' target="_blank" className='text-gray-300 hover:text-white transition duration-300'>
                About
              </Link>
            </li>
            <li className='my-4'>
